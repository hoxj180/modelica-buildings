...
block TrimAndRespond_revised
  "Block to inplement trim and respond logic with changing trim and respond percentages"
...
protected
  ...
  CDL.Reals.Switch                     tORr "trim or respond"
  ...
  CDL.Reals.Sources.Constant                        maxSetCon(k=maxSet)
...
equation
  ...
  connect(swi3.y, tORr.u1) annotation (Line(points={{142,-150},{148,-150},{148,-114},
          {112,-114},{112,-94},{118,-94}}, color={0,0,127}));
  connect(greThr.y, tORr.u2) annotation (Line(points={{42,-50},{112,-50},{112,-86},
          {118,-86}}, color={255,0,255}));
  connect(triAmoCon.y, tORr.u3) annotation (Line(points={{-178,-80},{110,-80},{110,
          -78},{118,-78}}, color={0,0,127}));
  connect(maxSetCon.y, min1.u2) annotation (Line(points={{-18,70},{-12,70},{-12,
          94},{-4,94}}, color={0,0,127}));
  connect(add1.y, min1.u1) annotation (Line(points={{-18,100},{-10,100},{-10,106},
          {-4,106}}, color={0,0,127}));
  connect(min1.y, maxInp.u1) annotation (Line(points={{20,100},{30,100},{30,106},
...
<ul>
<li>
Oct 11, 2024, by Julia Ho:<br/>
Changed add block summing trim and respond values to a switch that chooses between trim and respond values based on whether the number of requests &gt; ignReq to more accurately replicate Guideline 36 controls.
<li>
